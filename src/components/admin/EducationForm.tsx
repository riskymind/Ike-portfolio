  ...
  return (
    <form className='flex flex-col gap-8' method='POST' onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='flex gap-2'>
          <div className='flex-1 flex-col'>
            ...
            <div className='flex-1 flex-col'>
              ...
              <input type="text" placeholder='Choose Year' className='w-full border px-3 py-2 rounded' id='date' {...register("period")}/>
        ...
        <div className='flex flex-col gap-1'>
            ...
            <Image  src={logo} alt="school logo" width={100} height={100} className="rounded" />
            <UploadButton
