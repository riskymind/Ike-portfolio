...
import {expDefaultValues} from "@/lib/constants/index"
...
const [descriptions, setDescriptions] = useState<string[]>(exp?.description || []);
    ...
    <form className='flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='flex gap-2'>
          <div className='flex-1 flex-col'>
            <label htmlFor="date" className='block font-medium mb-1'>Period</label>
            <input type="text" className='w-full border px-3 py-2 rounded' id='date' {...register("period")}/>
        ...
        <div className='flex flex-col gap-1'>
            ...
            <UploadButton
                ...
                onClientUploadComplete={(res) => setValue('logo', res[0].ufsUrl)}
       ...
       <div className='flex flex-col gap-2'>
            ...
            <div className='flex gap-2'>
                ...
                onKeyDown={(e) => {
                    ...
                    e.preventDefault();
                    if (!descriptions.includes(dutyInput.trim())) {
                        setDescriptions([...descriptions, dutyInput.trim()]);
                        setDutyInput('');
                    }
                    }
                }}/>
